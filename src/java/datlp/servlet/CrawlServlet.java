...
import datlp.service.CrawlService;
import datlp.service.CrawlServiceImpl;
...
//    private final String CRAWL_PAGE = "admin-crawl.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = SHOW_UNNORMALIZE_SERVLET;
        ServletContext context = this.getServletContext();
        String realPath = context.getRealPath("/");
        CrawlService crawlService = new CrawlServiceImpl();
        
        try {
            crawlService.crawlNutrition(realPath);
//            crawlService.crawlDish(realPath);
        } finally {
